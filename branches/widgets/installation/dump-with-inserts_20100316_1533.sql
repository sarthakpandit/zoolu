...
INSERT INTO `zoolu`.`categories` VALUES  (1,0,1,1,NULL,1,12,0),
 ...
 (67,0,67,1,NULL,1,12,0),
 (68,67,67,1,NULL,2,9,1),
 (69,67,67,1,NULL,10,11,1),
 (70,68,67,1,NULL,3,4,2),
 (71,68,67,1,NULL,5,6,2),
 (72,68,67,1,NULL,7,8,2);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`categoryTitles` VALUES  (1,1,1,'Seiten Kategorien',0,'0000-00-00 00:00:00'),
 ...
 (85,70,1,'News',6,'2010-03-06 18:11:37'),
 (86,71,1,'Ventilations',6,'2010-03-06 18:12:07'),
 (87,72,1,'Recommendations',6,'2010-03-06 18:13:02');
UNLOCK TABLES;
...
CREATE TABLE  `zoolu`.`fields` (
  ...
  `isSqlKeyValuePair` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
...
INSERT INTO `zoolu`.`fields` VALUES  (1,1,'title',1,NULL,NULL,NULL,12,0,1,1,1,0,NULL,0,NULL),
 (2,10,'description',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (3,1,'title',5,NULL,NULL,NULL,12,0,1,1,1,0,NULL,0,NULL),
 (4,1,'articletitle',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (5,12,'mainpics',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (6,10,'description',6,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (7,12,'pics',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (8,13,'docs',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (10,2,'shortdescription',5,NULL,NULL,NULL,9,0,0,0,1,0,NULL,0,NULL),
 (11,11,'template',1,NULL,NULL,NULL,12,0,0,0,0,0,NULL,0,NULL),
 (17,1,'title',1,NULL,NULL,NULL,12,0,1,1,1,0,NULL,0,NULL),
 (18,12,'block_pics',1,NULL,NULL,NULL,3,0,0,0,1,0,NULL,0,NULL),
 (19,10,'block_description',1,NULL,NULL,NULL,9,0,0,0,1,0,NULL,0,NULL),
 (20,1,'block_title',1,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (21,16,'page_tags',6,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (22,17,'category',6,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title, tbl.depth AS depth FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 1 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',12,0,1,0,1,0,NULL,0,1),
 (23,1,'video_title',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (24,2,'video_embed_code',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (25,1,'pics_title',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (26,1,'docs_title',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (27,18,'url',3,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (28,19,'internal_link',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (29,10,'block_description',6,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (30,1,'block_title',5,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (31,1,'entry_number',1,NULL,NULL,NULL,4,0,0,0,1,0,NULL,0,NULL),
 (34,20,'entry_category',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title, (tbl.depth-1) AS depth FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 1 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 (37,1,'entry_title',5,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (40,21,'title',5,NULL,NULL,NULL,12,0,1,0,1,0,NULL,0,NULL),
 (41,1,'top_number',1,NULL,NULL,NULL,4,0,0,0,1,0,NULL,0,NULL),
 ...
 (43,1,'top_title',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (44,1,'entry_number',1,NULL,NULL,NULL,4,0,0,0,1,0,NULL,0,NULL),
 (45,20,'entry_nav_point',1,NULL,NULL,'SELECT folders.id, folderTitles.title, folders.depth FROM folders INNER JOIN folderTitles ON folderTitles.folderId = folders.folderId AND folderTitles.version = folders.version AND folderTitles.idLanguages = %LANGUAGE_ID% INNER JOIN rootLevels ON rootLevels.id = folders.idRootLevels INNER JOIN rootLevelTitles ON rootLevelTitles.idRootLevels = rootLevels.id WHERE folders.idRootLevels = %ROOTLEVEL_ID% ORDER BY folders.lft, folders.sortPosition ASC, folders.sortTimestamp DESC',4,0,0,0,1,0,NULL,0,1),
 (46,1,'entry_title',5,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (47,9,'entry_sorttype',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 12 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN ( rootCat.lft +1 ) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 (48,4,'entry_sortorder',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 13 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN ( rootCat.lft +1 ) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 ...
 (54,22,'video',1,NULL,NULL,'SELECT tbl.id AS id, tbl.title AS title FROM videoTypes AS tbl',12,0,0,0,1,0,NULL,0,1),
 (55,12,'pic_shortdescription',1,NULL,NULL,NULL,3,0,0,0,1,0,NULL,0,NULL),
 (56,17,'label',6,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title, tbl.depth AS depth FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 21 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',12,0,1,0,1,0,NULL,0,1),
 (59,9,'entry_viewtype',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 27 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 (60,20,'entry_label',6,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title, (tbl.depth-1) AS depth FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 21 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 ...
 (64,3,'option',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 42 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN ( rootCat.lft +1 ) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',12,0,0,0,1,0,NULL,0,1),
 (65,1,'fname',1,NULL,NULL,NULL,6,0,1,1,1,0,NULL,0,NULL),
 (66,1,'sname',1,NULL,NULL,NULL,6,0,1,1,1,0,NULL,0,NULL),
 (67,1,'datetime',1,NULL,NULL,NULL,6,0,1,0,1,0,NULL,0,NULL),
 (68,1,'event_duration',1,NULL,NULL,NULL,6,0,0,0,1,0,NULL,0,NULL),
 (69,1,'event_street',1,NULL,NULL,NULL,9,0,0,0,1,0,NULL,0,NULL),
 (70,1,'event_streetnr',1,NULL,NULL,NULL,3,0,0,0,1,0,NULL,0,NULL),
 (71,1,'event_plz',1,NULL,NULL,NULL,3,0,0,0,1,0,NULL,0,NULL),
 (72,1,'event_city',1,NULL,NULL,NULL,9,0,0,0,1,0,NULL,0,NULL),
 (73,1,'event_location',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (74,1,'event_max_members',1,NULL,NULL,NULL,6,0,0,0,1,0,NULL,0,NULL),
 (75,1,'event_costs',1,NULL,NULL,NULL,6,0,0,0,1,0,NULL,0,NULL),
 (76,1,'salutation',1,NULL,NULL,NULL,6,0,1,0,1,0,NULL,0,NULL),
 (77,1,'title',1,NULL,NULL,NULL,6,0,1,0,1,0,NULL,0,NULL),
 (78,1,'position',1,NULL,NULL,NULL,12,0,1,0,1,0,NULL,0,NULL),
 (79,1,'phone',1,NULL,NULL,NULL,4,0,1,0,1,0,NULL,0,NULL),
 (80,1,'mobile',1,NULL,NULL,NULL,4,0,1,0,1,0,NULL,0,NULL),
 (81,1,'fax',1,NULL,NULL,NULL,4,0,1,0,1,0,NULL,0,NULL),
 (82,1,'email',1,NULL,NULL,NULL,6,0,1,0,1,0,NULL,0,NULL),
 (83,1,'website',1,NULL,NULL,NULL,6,0,1,0,1,0,NULL,0,NULL),
 (84,12,'pics',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (85,24,'speakers',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (86,9,'contact',1,NULL,NULL,'SELECT tbl.id AS id, CONCAT(tbl.fname,\' \',tbl.sname) AS title FROM contacts AS tbl WHERE tbl.idUnits = 1 ORDER BY tbl.fname ASC',12,0,0,0,1,0,NULL,0,1),
 (87,9,'event_status',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 49 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN ( rootCat.lft +1 ) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',6,0,0,0,1,0,NULL,0,1),
 (88,12,'banner_pics',1,NULL,NULL,NULL,3,0,0,0,1,0,NULL,0,NULL),
 (89,10,'banner_description',1,NULL,NULL,NULL,9,0,0,0,1,0,NULL,0,NULL),
 (90,1,'banner_title',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (91,12,'headerpics',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (92,2,'header_embed_code',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (93,1,'external',1,NULL,NULL,NULL,12,0,1,0,1,0,NULL,0,NULL),
 (94,1,'title',1,NULL,NULL,NULL,12,0,1,1,1,0,NULL,0,NULL),
 (95,4,'entry_depth',1,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 64 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft %WHERE_ADDON% BETWEEN (rootCat.lft+1) AND rootCat.rgt ORDER BY tbl.lft, categoryTitles.title',4,0,0,0,1,0,NULL,0,1),
 (96,21,'title',5,NULL,NULL,NULL,12,0,1,0,1,0,NULL,0,NULL),
 (97,1,'instruction_title',5,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (98,10,'instruction_description',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (99,1,'description',5,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (100,1,'department',1,NULL,NULL,NULL,6,0,0,0,1,0,NULL,0,NULL),
 (101,1,'position',1,NULL,NULL,NULL,6,0,0,0,1,0,NULL,0,NULL),
 (102,1,'content_responsible',1,NULL,NULL,'SELECT tbl.id AS id, CONCAT(tbl.fname,\' \',tbl.sname) AS title FROM contacts AS tbl WHERE tbl.idUnits = 1 ORDER BY tbl.fname ASC',6,0,0,0,1,0,NULL,0,1),
 (103,1,'organizational_responsible',1,NULL,NULL,'SELECT tbl.id AS id, CONCAT(tbl.fname,\' \',tbl.sname) AS title FROM contacts AS tbl WHERE tbl.idUnits = 1 ORDER BY tbl.fname ASC',6,0,0,0,1,0,NULL,0,1),
 (104,1,'steps_title',1,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (105,10,'steps_text',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (106,10,'short_description',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (107,1,'steps_who',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (108,12,'process_pic',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (109,10,'process_inputs',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (110,10,'risk_description',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (111,1,'rule_title',1,NULL,NULL,NULL,12,0,0,0,1,1,NULL,0,NULL),
 (112,10,'rule_text',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (113,10,'risk_measure',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (114,10,'process_output',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (115,10,'process_indicator',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (116,10,'process_instructions',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (117,10,'process_techniques',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (118,25,'gmaps',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (119,1,'title',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (120,10,'text',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (121,26,'url',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (122,1,'prop_pagination',1,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (123,27,'test',1,NULL,NULL,'SELECT id, title, text, mail, created FROM widget_BlogEntryComments tbl WHERE idWidget_BlogEntries = %WHERE_ADDON%',12,0,0,0,1,0,NULL,0,0),
 (124,16,'blog_entry_tags',6,NULL,NULL,NULL,12,0,0,0,1,0,NULL,0,NULL),
 (125,17,'category',6,NULL,NULL,'SELECT tbl.id AS id, categoryTitles.title AS title, tbl.depth AS depth FROM categories AS tbl INNER JOIN categoryTitles ON categoryTitles.idCategories = tbl.id AND categoryTitles.idLanguages = %LANGUAGE_ID%, categories AS rootCat WHERE rootCat.id = 67 AND tbl.idRootCategory = rootCat.idRootCategory AND tbl.lft BETWEEN (rootCat.lft + 1) AND rootCat.rgt %WHERE_ADDON% ORDER BY tbl.lft, categoryTitles.title',12,0,1,0,1,0,NULL,0,1);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`fileAttributes` VALUES  (1,3,600,345);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`fileTitles` VALUES  (3,3,1,'Computer_keyboard_with_\'asdf\'_highlighted','','2010-03-16 14:31:13');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`files` VALUES  (3,'4b9f881ef1ba0',6,'',5,2,0,1,'4b9f881ef1ba0.jpg',NULL,6,'2010-03-16 14:31:11',26,'jpg','image/jpeg',1,0);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`folder-DEFAULT_FOLDER-1-Instances` VALUES  (4,'4a2910cf9583d',1,1,'',3,3,'2009-06-05 14:34:23','2009-06-05 14:34:23'),
 ...
 (10,'4b599be1259d9',1,1,'',6,6,'2010-01-22 13:36:49','2010-02-09 11:42:12'),
 (11,'4b8255bed24ff',1,1,'',6,6,'2010-02-22 11:00:30','2010-02-22 11:00:30');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`folderTitles` VALUES  (4,'4a2910cf9583d',1,1,'TEST',3,3,'2009-06-05 14:34:23','2009-06-05 14:34:23'),
 ...
 (10,'4b599be1259d9',1,1,'Hauptpunkt 1',6,6,'2010-01-22 13:36:49','2010-02-09 11:42:12'),
 (11,'4b8255bed24ff',1,1,'Unterpunkt 1',6,6,'2010-02-22 11:00:30','2010-02-22 11:00:30');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`folders` VALUES  (4,1,1,0,3,1,2,0,0,NULL,0,'2009-06-05 14:34:23','4a2910cf9583d',1,3,3,0,'2009-06-05 14:34:23','2009-06-05 14:34:23',NULL,1,1,0,0,NULL),
 ...
 (8,1,1,0,1,1,4,0,0,NULL,1,'2010-01-22 13:36:49','4b599be1259d9',1,6,6,0,'2010-01-22 13:36:49','2010-02-22 11:00:30',NULL,2,1,1,0,NULL),
 (9,1,1,8,1,2,3,1,0,NULL,3,'2010-02-22 11:00:30','4b8255bed24ff',1,6,6,0,'2010-02-22 11:00:30','2010-02-22 11:00:30',NULL,1,1,1,0,NULL);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`page-DEFAULT_OVERVIEW-1-Instances` VALUES  (5,'4b45aabb9cf71',1,1,6,'','','',NULL,NULL,6,'2010-01-07 10:35:57','2010-01-07 11:20:21'),
 (6,'4b599be130b50',1,1,6,'','','',NULL,NULL,6,'2010-03-07 20:56:03','2010-03-07 20:56:03');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`page-DEFAULT_OVERVIEW-1-Region15-Instances` VALUES  (23,'4b45aabb9cf71',1,1,1,'Übersicht Hauptpunkt 1',0,0,30,10,18,15,66),
 (24,'4b599be130b50',1,1,1,'Test1',53,0,28,10,18,14,65);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`page-DEFAULT_PAGE_1-1-Region11-Instances` VALUES  (280,'4b61ee1fbc4ae',1,1,1,'',''),
 (285,'4b8e5a23871d7',1,1,1,'',''),
 (287,'4b599c44efd52',1,1,1,'','');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`pageCategories` VALUES  (1,'4b61ee1fbc4ae',1,1,53,6,6,'2010-01-29 11:59:13','2010-01-29 11:59:13'),
 (3,'4b599c44efd52',1,1,53,6,6,'2010-03-07 20:56:40','2010-03-07 20:56:40');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`pageGmaps` VALUES  (23,'4b61ee1fbc4ae',1,1,'47.503042','9.747067',6,NULL,'2010-01-29 11:59:13'),
 (28,'4b8e5a23871d7',1,1,'47.503042','9.747067',6,NULL,'2010-03-03 13:46:27'),
 (30,'4b599c44efd52',1,1,'47.503042','9.747067',6,NULL,'2010-03-07 20:56:40');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`pageTitles` VALUES  (43,'4b45a967b4a62',1,1,'Home',6,6,'2010-01-07 10:31:20','2010-01-07 10:31:20'),
 ...
 (46,'4b599be130b50',1,1,'Hauptpunkt 1',6,6,'2010-01-22 13:36:49','2010-03-07 20:56:03'),
 (47,'4b599c44efd52',1,1,'Seite 1',6,6,'2010-01-22 13:38:29','2010-03-07 20:56:40'),
 (48,'4b61ee1fbc4ae',1,1,'Seite 2',6,6,'2010-01-28 21:05:51','2010-01-29 11:59:13'),
 (51,'4b79b17e95a27',1,1,'sdfg',6,6,'2010-02-15 21:41:34','2010-02-15 21:41:34'),
 (52,'4b79b1ab96e4a',1,1,'sdfh',6,6,'2010-02-15 21:42:19','2010-02-15 21:42:19'),
 (55,'4b79b2e6da6bf',1,1,'asdg',6,6,'2010-02-15 21:47:34','2010-02-15 21:47:34'),
 (56,'4b79b30f43414',1,1,'asdg',6,6,'2010-02-15 21:48:15','2010-02-15 21:48:15'),
 (57,'4b79b325728c3',1,1,'eagzsdfg',6,6,'2010-02-15 21:48:37','2010-02-15 21:48:37'),
 (58,'4b79b3b3601f3',1,1,'dfgjdfgh',6,6,'2010-02-15 21:50:59','2010-02-15 21:50:59'),
 (59,'4b8255bf12a1b',1,1,'Unterpunkt 1',6,6,'2010-02-22 11:00:31','2010-02-22 11:00:31'),
 (60,'4b8e5a23871d7',1,1,'asdf',6,6,'2010-03-03 13:46:27','2010-03-03 13:46:27');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`pages` VALUES  (1,8,3,1,1,1,1,1,6,0,'2010-01-07 10:31:20','4b45a967b4a62',1,6,6,'2010-01-07 10:34:51','2010-02-12 10:07:48','1999-11-30 00:00:00',2),
 ...
 (4,7,4,3,1,1,8,2,6,0,'2010-01-22 13:36:49','4b599be130b50',1,6,0,'2010-01-22 13:36:49','2010-03-07 20:56:03','2010-03-07 20:55:31',2),
 (5,2,1,1,0,1,8,2,6,1,'2010-01-22 13:38:28','4b599c44efd52',1,6,0,'2010-01-22 13:38:28','2010-03-07 20:56:40','2010-01-22 13:38:49',2),
 ...
 (9,2,2,1,1,0,10,2,6,0,'2010-02-15 21:41:34','4b79b17e95a27',1,6,0,'2010-02-15 21:41:34','2010-02-15 21:41:34',NULL,1),
 (10,2,2,1,1,0,11,2,6,0,'2010-02-15 21:42:19','4b79b1ab96e4a',1,6,0,'2010-02-15 21:42:19','2010-02-15 21:42:19',NULL,1),
 (13,2,2,1,1,0,12,2,6,0,'2010-02-15 21:47:34','4b79b2e6da6bf',1,6,0,'2010-02-15 21:47:34','2010-02-15 21:47:34',NULL,1),
 (14,2,2,1,1,0,13,2,6,0,'2010-02-15 21:48:15','4b79b30f43414',1,6,0,'2010-02-15 21:48:15','2010-02-15 21:48:15',NULL,1),
 (15,2,2,1,1,0,14,2,6,0,'2010-02-15 21:48:37','4b79b325728c3',1,6,0,'2010-02-15 21:48:37','2010-02-15 21:48:37',NULL,1),
 (16,2,2,1,1,0,15,2,6,0,'2010-02-15 21:50:59','4b79b3b3601f3',1,6,0,'2010-02-15 21:50:59','2010-02-15 21:50:59',NULL,1),
 (17,2,2,1,1,1,9,2,6,2,'2010-02-22 11:00:31','4b8255bf12a1b',1,6,0,'2010-02-22 11:00:31','2010-02-22 11:00:31',NULL,1),
 (18,2,1,1,0,0,8,2,6,4,'2010-03-03 13:46:27','4b8e5a23871d7',1,6,0,'2010-03-03 13:46:27','2010-03-03 13:46:27',NULL,2);
UNLOCK TABLES;
...
--
-- Definition of table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-InstanceFiles`
--

DROP TABLE IF EXISTS `zoolu`.`subwidget-W_BLOG_ARTICLE-1-InstanceFiles`;
CREATE TABLE  `zoolu`.`subwidget-W_BLOG_ARTICLE-1-InstanceFiles` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `subwidgetId` varchar(255) NOT NULL,
  `version` int(10) unsigned NOT NULL,
  `idLanguages` int(10) unsigned NOT NULL DEFAULT '1',
  `idFiles` bigint(20) unsigned NOT NULL,
  `idFields` bigint(20) unsigned NOT NULL,
  ...
  KEY `idFiles` (`idFiles`),
  CONSTRAINT `subwidget-W_BLOG_ARTICLE-1-InstanceFiles_ibfk_2` FOREIGN KEY (`idFiles`) REFERENCES `files` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Dumping data for table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-InstanceFiles`
--

/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-InstanceFiles` DISABLE KEYS */;
LOCK TABLES `subwidget-W_BLOG_ARTICLE-1-InstanceFiles` WRITE;
INSERT INTO `zoolu`.`subwidget-W_BLOG_ARTICLE-1-InstanceFiles` VALUES  (4,'4b8e6049e8ea8',1,1,3,5);
UNLOCK TABLES;
/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-InstanceFiles` ENABLE KEYS */;


--
-- Definition of table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles`
--

DROP TABLE IF EXISTS `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles`;
CREATE TABLE  `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `subwidgetId` varchar(255) NOT NULL,
  `version` int(10) unsigned NOT NULL,
  `idLanguages` int(10) unsigned NOT NULL DEFAULT '1',
  ...
  KEY `idRegionInstances` (`idRegionInstances`),
  KEY `idFiles` (`idFiles`),
  CONSTRAINT `subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles_ibfk_2` FOREIGN KEY (`idFiles`) REFERENCES `files` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Dumping data for table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles`
--

/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles` DISABLE KEYS */;
LOCK TABLES `subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles` WRITE;
INSERT INTO `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles` VALUES  (1,'4b8e6049e8ea8',1,1,2,3,18);
UNLOCK TABLES;
/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-Region11-InstanceFiles` ENABLE KEYS */;


--
-- Definition of table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-Instances`
--

DROP TABLE IF EXISTS `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-Instances`;
CREATE TABLE  `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-Instances` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-Instances`
--

/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-Region11-Instances` DISABLE KEYS */;
LOCK TABLES `subwidget-W_BLOG_ARTICLE-1-Region11-Instances` WRITE;
INSERT INTO `zoolu`.`subwidget-W_BLOG_ARTICLE-1-Region11-Instances` VALUES  (2,'4b8e6049e8ea8',1,1,1,'jklö','<p>asdfasdfasdf</p>');
UNLOCK TABLES;
/*!40000 ALTER TABLE `subwidget-W_BLOG_ARTICLE-1-Region11-Instances` ENABLE KEYS */;
...
INSERT INTO `zoolu`.`subwidgetCategories` VALUES  (8,'4b4dbf01e4d7a',0,1,69,6,6,'2010-01-20 14:38:31','2010-01-20 14:38:31'),
 ...
 (12,'4b73d8f010dfb',0,1,68,6,6,'2010-02-11 11:16:16','2010-02-11 11:16:16'),
 (13,'4b73d91b37dfc',0,1,68,6,6,'2010-02-11 11:16:59','2010-02-11 11:16:59'),
 (14,'4b73d9347b83b',0,1,68,6,6,'2010-02-11 11:17:24','2010-02-11 11:17:24'),
 (15,'4b73dae99186b',0,1,68,6,6,'2010-02-11 11:24:41','2010-02-11 11:24:41'),
 (16,'4b73db87f2d95',0,1,68,6,6,'2010-02-11 11:27:20','2010-02-11 11:27:20'),
 (17,'4b73dd3e2e66f',0,1,68,6,6,'2010-02-11 11:34:38','2010-02-11 11:34:38'),
 (18,'4b73dd9490a3b',0,1,69,6,6,'2010-02-11 11:36:04','2010-02-11 11:36:04'),
 (19,'4b73fb9044c77',0,1,68,6,6,'2010-02-11 13:44:00','2010-02-11 13:44:00'),
 (20,'4b751d5ab4f76',0,1,68,6,6,'2010-02-12 10:20:26','2010-02-12 10:20:26'),
 (28,'4b7aeec673eff',0,1,68,6,6,'2010-03-01 09:47:42','2010-03-01 09:47:42'),
 (29,'4b7aeec673eff',1,1,68,6,6,'2010-03-01 10:03:09','2010-03-01 10:03:09');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`subwidgets` VALUES  (1,'4b8e6049e8ea8','4b7aee9b3488f','2010-03-03 14:12:42',6,1,3,1,2,6,0,'2010-03-16 14:38:22',NULL);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`tagSubwidgets` VALUES  (1,'4b73d8f010dfb',0,1),
 (1,'4b73d91b37dfc',0,1),
 (1,'4b73d9347b83b',0,1),
 (1,'4b73dae99186b',0,1),
 (1,'4b73db87f2d95',0,1),
...
INSERT INTO `zoolu`.`urls` VALUES  (1,'4b45a967b4a62',1,1,0,1,'0',NULL,'',3,3,'2009-04-24 10:14:16','2010-01-07 10:31:46'),
 ...
 (173,'4b73ef6807491',1,1,1,1,NULL,NULL,'hauptpunkt-2/',6,6,'2010-02-11 12:52:08','2010-02-11 12:52:08'),
 (174,'4b7aee9b3488f',1,2,0,1,NULL,NULL,'blog/',6,6,'2010-02-16 20:14:42','2010-02-16 20:14:42'),
 (176,'4b8255bf12a1b',1,1,1,1,NULL,NULL,'hauptpunkt-1/unterpunkt-1/',6,6,'2010-02-22 11:00:31','2010-02-22 11:00:31'),
 (177,'4b82568333b06',1,2,0,1,NULL,NULL,'hauptpunkt-1/unterpunkt-1/interner-blog/',6,6,'2010-02-22 11:04:04','2010-02-22 11:04:04'),
 (179,'4b84541f5fef5',1,2,0,1,NULL,NULL,'asdf/',6,6,'2010-02-23 23:18:14','2010-02-23 23:18:14'),
 (183,'4b8e5a23871d7',1,1,1,1,NULL,NULL,'hauptpunkt-1/asdf',6,6,'2010-03-03 13:46:27','2010-03-03 13:46:27'),
 (186,'4b8e6049e8ea8',1,3,1,1,NULL,NULL,'blog/asdf',6,6,'2010-03-03 14:12:42','2010-03-03 14:12:42');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`widgetInstanceProperties` VALUES  (4,'pagination','10',1),
 (5,'pagination','15',2);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`widgetInstanceTitles` VALUES  (1,'4b7aee9b3488f',1,'Blog',6,6,'2010-02-16 20:14:42','0000-00-00 00:00:00',1),
 (2,'4b82568333b06',1,'Interner Blog',6,6,'2010-02-22 11:04:04','0000-00-00 00:00:00',1),
 (3,'4b84541f5fef5',1,'asdf',6,6,'2010-02-23 23:18:14','0000-00-00 00:00:00',1);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`widgetInstances` VALUES  (1,15,2,1,1,6,'2010-02-16 20:14:41',NULL,'0000-00-00 00:00:00',2,'2010-02-16 20:14:41',6,NULL,1,'4b7aee9b3488f',1,1),
 (2,15,1,9,2,6,'2010-02-22 11:04:04',NULL,'0000-00-00 00:00:00',1,'2010-02-22 11:04:04',6,NULL,1,'4b82568333b06',1,1);
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`widget_BlogEntries` VALUES  (1,'asdf','','4b8e6049e8ea8');
UNLOCK TABLES;
...
INSERT INTO `zoolu`.`widget_BlogEntryComments` VALUES  (3,1,'Daniel','In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, ','daniel.rotter@vol.at','2010-03-08 10:50:14'),
 (4,1,'Florian','Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui.','flo@f-mathis.net','2010-03-08 10:50:14');
UNLOCK TABLES;
