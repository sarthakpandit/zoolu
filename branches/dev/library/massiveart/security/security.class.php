  ...
  public function addFoldersToAcl(Model_Folders $objModelFolders, $intZoneId = self::ZONE_ZOOLU){
    try{
      ...
      foreach($arrResources as $objResource){
        ...
        $strResourceId = ($objResource->languageId == 0) ? Security::RESOURCE_FOLDER_PREFIX.$objResource->id : Security::RESOURCE_ROOT_LEVEL_PREFIX.$objResource->id.'_'.$objResource->languageId;
